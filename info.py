...
BOT_TOKEN = environ['6072377974:AAG0NqRVMevnkuCRVaT5MpKJ-DFlyEyOzZs']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5431311680').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001932781121').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5431311680').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ck:ck@cluster0.ax9q9lz.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "ck")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moviesworld_malayalam')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+kzIZY6esOHw5YmRl')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', "-1001917005151"))
