...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://AJTGBOTS:AJTGBOTS@cluster0.97lwtc6.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "AJTGBOTS")
